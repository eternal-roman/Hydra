            ...
            "properties": {
                ...
                "overrides": {
                    ...
                    "description": (
                        ...
                        '{"SOL/USDC": {"momentum_rsi_upper": 78.0}}'
                    ),
                },
                "pairs": {
                    "type": "array",
                    "items": {"type": "string"},
                    "description": "Pairs to test. Defaults to ['SOL/USDC'].",
                },
                "n_candles": {
                    "type": "integer",
                    "minimum": 50,
...
class BacktestToolDispatcher:
    ...
    def _tool_run_backtest(
        ...
        pairs = tuple(tool_input.get("pairs") or ["SOL/USDC"])
    ...
    def _tool_sweep_param(
        ...
        try:
            pairs = tuple([pair]) if pair else ("SOL/USDC",)
